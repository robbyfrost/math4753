...
#' @param fun function
#' @param alpha 1 - confidence interval in question
#' @param cx
#' @param ...
#'
#' @return A histogram of the input distribution displaying functions (mean, sd, IQR, etc) of the distribution and a confidence interval.
#' @export
#'
#' @examples
#' \dontrun{myboot2(x = sam, fun = "var", alpha = .2)}
